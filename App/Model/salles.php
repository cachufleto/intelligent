...
{
    public function sallesUpdate($sql_set, $id_salle)
    {
    ...
    public function setSallesActive($id, $active)
    {
    ...
    public function selectSallesOrder($order, $listeId)
    {
    ...
    public function selectSallesUsers($order)
    {
// selection de tout les users sauffe le super-ADMIN
    ...
    public function selectListeDistinc($champ, $table)
    {
    ...
    public function setProduit($_id, $key)
    {
    ...
    public function setSalle($sql_champs, $sql_value)
    {
        // insertion en BDD
    ...
    public function selectSalleReserves($date, $id)
    {
        $sql = "SELECT tranche FROM commandes WHERE date_reserve = '$date' AND id_salle = $id";
        return executeRequete($sql);
    }

    public function selectSalleReservesMembres($date, $id)
    {
